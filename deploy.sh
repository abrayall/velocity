...
" 2>/dev/null)
        ...
        DESIRED_FEATURES='["buildpack-stack=ubuntu-22",]'
...
# Desired values
desired_features = set(['buildpack-stack=ubuntu-22'])
desired_domains = [
